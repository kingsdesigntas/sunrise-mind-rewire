    ...
    <header className="bg-card w-full">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a href="#what-is-theta" className="text-sm font-medium text-foreground/70 hover:text-foreground transition-colors">Theta State</a>
          <a href="#neuroplasticity" className="text-sm font-medium text-foreground/70 hover:text-foreground transition-colors">Science</a>
          ...
          <a href="#categories" className="text-sm font-medium text-foreground/70 hover:text-foreground transition-colors">Categories</a>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            className="relative flex flex-col items-center lg:flex-shrink-0">
              ...
              <div className="relative w-[260px] md:w-[300px]">
                <img
                src="/lovable-uploads/9423868e-ea59-4a71-9d3c-55413282726b.jpg"
                alt="Theta Clock app screenshot showing affirmation alarm interface"
