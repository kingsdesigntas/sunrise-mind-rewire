  ...
  return (
    <section id="pricing" className="relative bg-deep-blue py-20 md:py-28">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSection>
          <h2 className="text-3xl md:text-5xl text-primary-foreground mb-4 text-center">Early Bird Pricing</h2>
          <p className="text-primary-foreground/70 max-w-lg mx-auto mb-12 text-lg text-center">
            Get lifetime access — completely free during our beta launch. This offer will close after the first 100
            users for a testing phase.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.1}>
          <div className="flex flex-col sm:flex-row gap-6 max-w-2xl mx-auto mb-14">
            ...
            <div className="flex-1 rounded-2xl border border-primary-foreground/15 bg-primary-foreground/5 p-8 text-center opacity-60">
              <p className="text-primary-foreground/60 text-sm font-medium uppercase tracking-wider mb-4">
                Regular Price
              </p>
        ...
        <AnimatedSection delay={0.3}>
          <p className="mt-10 text-center text-primary-foreground/50 text-sm">
            We will email you to complete our feedback survey.
          </p>
        </AnimatedSection>
      </div>
    </section>
