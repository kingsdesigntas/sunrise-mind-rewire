...
const AffirmationCategoriesSection = () => (
  <section id="categories" className="relative bg-background pt-16 md:pt-24 py-0">
    <div className="container mx-auto px-6">
      <AnimatedSection>
        <h2 className="text-3xl md:text-5xl text-foreground text-center mb-4">Affirmation Categories</h2>
